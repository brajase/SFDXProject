    ...
    stages {
        ...
        stage('Deploy') {
            steps {
                echo 'Deploying....'
                script{                   
                        stdout = bat(returnStdout:true , script: "C:\\Program%20Files\\sfdx\\bin\\sfdx force:auth:jwt:grant --clientid 3MVG9szVa2RxsqBYXscs6zhOGSsPG_Pmr3Ik2ceNuLNQLAIsGwRfJ96YGtZRmbC7W62DhZPzEc3t.4RpkElFq --jwtkeyfile C:\\MyApplications\\Jenkins\\keys\\kaaladev2.PEM --username chandar_bala@hotmail.com.shield --instanceurl https://login.salesforce.com --setdefaultusername")
